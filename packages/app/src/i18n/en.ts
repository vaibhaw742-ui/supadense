export const dict = {
  ...
  "prompt.example.1": "Give me articles on agents which is super deep and full of design ideas",
  "prompt.example.2": "I want a roadmap to learn about harness in agent engineering",
  "prompt.example.3": "What's new going in RAG?",
  "prompt.example.4": "Does this blog have new information that is not present in knowledge base",
  "prompt.example.5": "I don't have great understanding of llm inference, can you create 10 questions to check my knowledge?",
  "prompt.example.6": "Give me articles on agents which is super deep and full of design ideas",
  "prompt.example.7": "I want a roadmap to learn about harness in agent engineering",
  "prompt.example.8": "What's new going in RAG?",
  "prompt.example.9": "Does this blog have new information that is not present in knowledge base",
  "prompt.example.10": "I don't have great understanding of llm inference, can you create 10 questions to check my knowledge?",
  "prompt.example.11": "Give me articles on agents which is super deep and full of design ideas",
  "prompt.example.12": "I want a roadmap to learn about harness in agent engineering",
  "prompt.example.13": "What's new going in RAG?",
  "prompt.example.14": "Does this blog have new information that is not present in knowledge base",
  "prompt.example.15": "I don't have great understanding of llm inference, can you create 10 questions to check my knowledge?",
  "prompt.example.16": "Give me articles on agents which is super deep and full of design ideas",
  "prompt.example.17": "I want a roadmap to learn about harness in agent engineering",
  "prompt.example.18": "What's new going in RAG?",
  "prompt.example.19": "Does this blog have new information that is not present in knowledge base",
  "prompt.example.20": "I don't have great understanding of llm inference, can you create 10 questions to check my knowledge?",
  "prompt.example.21": "Give me articles on agents which is super deep and full of design ideas",
  "prompt.example.22": "I want a roadmap to learn about harness in agent engineering",
  "prompt.example.23": "What's new going in RAG?",
  "prompt.example.24": "Does this blog have new information that is not present in knowledge base",
  "prompt.example.25": "I don't have great understanding of llm inference, can you create 10 questions to check my knowledge?",
  ...
  "prompt.action.attachFile": "Add resources",
  ...
  "sidebar.empty.title": "No Knowledge Base created",
  "sidebar.empty.description": "Create a Knowledge Base to get started",
