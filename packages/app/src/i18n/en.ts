export const dict = {
  ...
  "prompt.example.1": "Deep articles on agent design ideas",
  "prompt.example.2": "Roadmap to learn agent engineering",
  "prompt.example.3": "What's new in RAG?",
  "prompt.example.4": "Does this blog have info not in my KB?",
  "prompt.example.5": "10 questions to test my LLM inference knowledge",
  "prompt.example.6": "Add a category Databases",
  "prompt.example.7": "Deep articles on agent design ideas",
  "prompt.example.8": "Roadmap to learn agent engineering",
  "prompt.example.9": "What's new in RAG?",
  "prompt.example.10": "Does this blog have info not in my KB?",
  "prompt.example.11": "10 questions to test my LLM inference knowledge",
  "prompt.example.12": "Add a category Databases",
  "prompt.example.13": "Deep articles on agent design ideas",
  "prompt.example.14": "Roadmap to learn agent engineering",
  "prompt.example.15": "What's new in RAG?",
  "prompt.example.16": "Does this blog have info not in my KB?",
  "prompt.example.17": "10 questions to test my LLM inference knowledge",
  "prompt.example.18": "Add a category Databases",
  "prompt.example.19": "Deep articles on agent design ideas",
  "prompt.example.20": "Roadmap to learn agent engineering",
  "prompt.example.21": "What's new in RAG?",
  "prompt.example.22": "Does this blog have info not in my KB?",
  "prompt.example.23": "10 questions to test my LLM inference knowledge",
  "prompt.example.24": "Add a category Databases",
  "prompt.example.25": "Deep articles on agent design ideas",
