  ...
  return (
    <div class="relative bg-background-base size-full overflow-hidden">
      ...
      <div class="absolute inset-0 flex flex-col md:flex-row px-2 gap-2">
        ...
        <div
          classList={{
            "@container relative shrink-0 flex flex-col min-h-0 h-full bg-background-base border border-border-weak-base flex-1 md:flex-none rounded-b-[12px] overflow-hidden": true,
