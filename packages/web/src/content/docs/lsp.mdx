---
title: LSP Servers
description: Supadense integrates with your LSP servers.
---

Supadense integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

Supadense comes with several built-in LSP servers for popular languages:
