---
title: Share
description: Share your Supadense conversations.
---

Supadense's share feature allows you to create public links to your Supadense conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Supadense:
...
Supadense supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Supadense uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
