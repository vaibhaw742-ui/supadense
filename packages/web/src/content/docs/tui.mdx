---
title: TUI
description: Using the Supadense terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Supadense provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Supadense starts the TUI for the current directory.
...
When using the Supadense TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Supadense. Allows you to select from available providers and add their API keys.
...
Exit Supadense. _Aliases_: `/quit`, `/q`
