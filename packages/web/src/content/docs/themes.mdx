...
With Supadense you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Supadense uses our own `opencode` theme.
...
Supadense comes with several built-in themes.
...
- Want Supadense to match their terminal's appearance
...
Supadense supports a flexible JSON-based theme system that allows users to create and customize themes easily.
...
{
  "$schema": "https://supadense.com/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
