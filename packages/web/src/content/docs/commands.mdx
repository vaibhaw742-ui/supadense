...
You can add custom commands through the Supadense config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Supadense [config](/docs/config):
