...
Agent skills let Supadense discover reusable instructions from your repo or home directory.
...
Supadense searches these locations:
...
For project-local paths, Supadense walks up from your current working directory until it reaches the git worktree.
...
Supadense lists available skills in the `skill` tool description.
